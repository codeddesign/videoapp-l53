  ...
  <div>
    <div class="page-index">
      ...
      <ul class="campaignstats-row">
        ...
        <li>
          <stats title="fill-rate" :value="123123" :chart-data="[1,2,3,4,5]" chart-color="#7772A7"  :isPercentage="true"></stats>
        </li>
        <li>
          <stats title="error-rate" :value="4" :ispercentage="true" color="#009dd7" :chart-data="[1,2,3,4,5]" chart-color="rgb(0, 157, 215)" :isPercentage="true"></stats>
        </li>
        <li>
          <stats title="use-rate" :value="12" :ispercentage="true" color="#009dd7" :chart-data="[1,2,3,4,5]" chart-color="rgb(0, 157, 215)" :isPercentage="true"></stats>
        </li>
      </ul>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      request() {
        this.$http.get('/api/stats/requests?time=' + this.timeRange).then(
          (response) => {
